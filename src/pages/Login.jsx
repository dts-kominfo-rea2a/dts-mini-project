    ...
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-neutral-900 rounded-md shadow-xl shadow-neutral-800 lg:max-w-xl">
        ...
        <div className="flex mt-4 gap-x-2">
          ...
          <button className="flex items-center justify-center w-full p-2 border border-white rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-red-400 bg-neutral-100">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 32 32"
              className="w-5 h-5 fill-current"
