  ...
  return (
    <div className="flex">
      <div
        className={
          open
            ? "hover:cursor-pointer inline-flex h-[32px] w-full px-2 gap-x-2 items-center justify-between border border-black md:border-white rounded-md transition-all duration-100"
      ...
      >
        ...
        <input
          ...
          className={
            open
              ? "flex py-1.5 w-full outline-none bg-transparent text-black md:text-white"
              : "hidden"
          }
        />
      </div>
